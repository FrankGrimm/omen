...
def new_dataset(dsid=None):
    ...
    with db.session_scope() as dbsession:
        if dsid is None:
            ...
            dataset = db.dataset_by_id(dbsession, session['user'], dsid)
        ...
        if request.method == 'POST':
            ...
            if dsdirty and editmode == 'create':
        ...
        return render_template('dataset_new.html', error=err, dataset=dataset, editmode=editmode, previewdf=df, db=db, dbsession=dbsession)
